...
export const SIGNATURE_CARE = [
    ...
    { title: '보존진료', image: '/images/img-teeth-04.jpg' },
];
        ...
        slides: [
            {
                ...
                alt: '연세진치과 수술실 입구와 임플란트 우수 시술 인증 현판',
                title: '이런 분께 권해드립니다',
                items: [
...
export const FAQ = [
    ...
    },
    {
        ...
        items: [
            {
                q: '이가 흔들리는데 꼭 빼야 하나요?',
                a: '흔들린다고 모두 빼는 것은 아닙니다. 원인과 잇몸뼈 상태에 따라 살릴 수 있는 경우도 많으니, 정밀 진단 후 보존이 가능한지 먼저 판단해 드립니다.',
            },
            {
                q: '신경치료한 치아가 다시 아픈데, 빼야 하나요?',
                a: '바로 발치를 권하지 않습니다. 재신경치료로 살릴 가능성이 있다면 먼저 시도합니다. 다만 일반 신경치료보다 까다로워 결과를 장담하기는 어렵고, 치아 상태에 따라 신중히 판단합니다.',
            },
            {
                q: '신경치료 대신 그냥 임플란트를 하는 게 낫지 않나요?',
                a: '자연치아를 완전히 대신할 수 있는 것은 없습니다. 살릴 수 있다면 신경치료로 보존하는 것이 우선이며, 임플란트는 치아를 살리기 어려울 때 선택하는 마지막 단계입니다.',
            },
        ],
    },
    {
        ...
        items: [
            {
                q: '진료 기구는 어떻게 소독하나요?',
                a: '오토클레이브(고압증기 멸균기)로 매일 빠짐없이 멸균합니다. 기본 기구는 개별 파우치에 포장해 멸균한 뒤, 환자 한 분마다 새것을 개봉해 사용합니다.',
            },
            {
                q: '핸드피스도 멸균하나요?',
                a: '네. 핸드피스는 감염 관리가 까다로운 장비라, 니트람(Nitram) 핸드피스 전용 멸균기를 갖추고 체계적으로 멸균·관리합니다.',
            },
            {
                q: '임플란트 수술 기구는 따로 관리하나요?',
                a: '임플란트 수술과 발치 등 외과 진료에 쓰이는 모든 기구는 엄격한 멸균·소독 과정을 거쳐 별도로 관리합니다.',
            },
        ],
    },
];

...
export type CoreTab = {
    ...
    // 이미지 없는 보조 블록. 2개씩 가로로 배치한다.
    notes?: { title: string[]; desc: string; devices?: { name: string; desc: string }[] }[];
};
...
export const CORE_TABS: CoreTab[] = [
    {
        ...
        process: ['정밀 진단', '디지털 설계', '가이드 제작', '무절개 식립', '최종 보철'],
        compare: {
    ...
    },
    {
        ...
        process: ['정밀 진단', '분석 및 상담', '장치 선택 및 부착', '교정 치료', '유지 관리 (유지장치)'],
        system: [
            {
                title: ['폭넓은', '교정 범위'],
        ...
        notes: [
            {
                ...
                devices: [
                    ...
                    { name: '세라믹 자가결찰 교정(클리피씨)', desc: '치아색과 유사해 눈에 덜 띄는 방식' },
                    { name: '투명교정(세라핀)', desc: '투명하게 착용하고 스스로 탈착이 가능한 방식' },
                ],
            },
        ],
    },
    {
        ...
        desc: [
            ...
            {
                text: '임플란트 4~6개로 전체 치아를 회복하는 치료입니다.\n틀니의 불편함을 줄이고, 자연스러운 심미와\n씹는 기능을 함께 되찾을 수 있도록 돕습니다.',
                strong: true,
            },
        ],
        highlight: {
        ...
        process: ['정밀 진단', '디지털 설계', '임시 보철 제작', '임플란트 식립', '당일 임시 치아 장착', '최종 보철'],
        compare: {
        ...
        notes: [
            {
                title: ['수술 당일', '임시 치아'],
                desc: '수술 전 미리 디지털로 설계하고\n임시 보철을 제작하기 때문에,\n수술 당일 바로 임시 치아를 장착해 드립니다. 이가 없는 상태로 오래 지내실 필요 없이, 그날부터 웃고 식사하실 수 있습니다.',
            },
            {
                title: ['최소한의 임플란트로,', '합리적인 비용'],
                desc: '턱 전체에 임플란트를 심는 대신,\n힘을 가장 잘 지탱하는 위치에 4~6개만 정밀하게 식립합니다. 수술 부담과 비용은 줄이면서도 안정적으로 치아 전체를\n지지할 수 있습니다.',
            },
        ],
    },
    {
        ...
        desc: [
            ...
            {
                text: '연세진치과는 살릴 수 있는 치아라면 먼저 보존하는 것을 원칙으로 하며,\n자연치아를 지키기 위한 모든 방법을 먼저 찾습니다.',
                strong: true,
            },
        ],
        highlight: {
            ...
            slides: [
                {
                    ...
                    items: [
                        '신경까지 손상된 치아라도 곧바로 빼지 않고,\n신경치료(근관치료)를 통해 자연치아를 최대한 보존하는 것을 우선합니다.',
                ...
                },
                {
                    ...
                    items: [
                        '치아를 빼야 하는 기준은 정해진 공식으로\n나눌 수 없습니다. 치아의 상태, 뿌리와 잇몸뼈의 조건,\n앞으로의 사용 가능성을 하나하나 살펴, 환자분마다\n가장 나은 방향을 신중히 판단합니다.',
                        '살릴 수 없는 치아를 무리하게 붙잡지도,\n살릴 수 있는 치아를 쉽게 포기하지도 않습니다.',
                    ],
                },
            ],
        },
    },
    {
        ...
        desc: [
            ...
            {
                text: '연세진치과는 모든 기구와 장비를 원칙에 따라 철저히 멸균·소독하여,\n환자분이 안심하고 치료받으실 수 있는 환경을 유지하고 있습니다.',
                strong: true,
            },
        ],
        highlight: {
            ...
            slides: [
                ...
                },
                {
                    ...
                    items: [
                        '진료에 사용하는 기본 기구(미러, 핀셋, 익스플로러 등)는\n개별 파우치에 포장해 멸균한 뒤,\n환자 한 분마다 새것을 개봉해 사용합니다.',

        ...
        <section id="special" className="bg-texture py-16 md:py-24 lg:py-32" aria-labelledby="special-title">
            <div className="mx-auto w-full max-w-site px-5 md:px-8">
                ...
                <Reveal kind="scale" className="mt-10 md:mt-14">
                    <div className="relative overflow-hidden rounded-[18px] border-2 border-primary/25 bg-white shadow-[0_20px_50px_rgb(6_26_66/0.08)]">
                        {/* 카드 높이는 가장 긴 항목에 맞춰 고정한다. 4장을 같은 칸에 겹쳐 두고 활성 항목만 보인다 */}
                        <div className="grid">
                            {SPECIAL_CARE.items.map((card, index) => {
                                ...
                                return (
                                    <motion.article
                                        ...
                                        className={`col-start-1 row-start-1 grid min-h-[520px] lg:min-h-[440px] lg:grid-cols-[minmax(0,1fr)_420px] ${
                                            on ? '' : 'pointer-events-none'
                                        }`}
                                    >
                                        <div className="flex flex-col justify-center px-7 py-10 md:px-12 lg:px-10 lg:py-9 xl:px-14">
                                            ...
                                            {card.highlight && (
                                                <p className="text-wrap-design mt-6 text-[17px] leading-[1.75] font-extrabold text-primary/55 lg:mt-4">
                                                    {card.highlight}
                                                </p>
                                            )}

                                            <p className="text-wrap-design mt-6 text-[16px] leading-[1.75] font-semibold text-basic lg:mt-4 lg:text-[17px] lg:leading-[1.65]">
                                                {card.body.map((part) =>
                                                    part.strong ? (
